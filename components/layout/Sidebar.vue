      ...
      >
        <div class="h-full pt-10 px-5 relative">
          <div @click="closeSidebarPanel">
            ...
            <a href="mailto:pablogabriel1941@gmail.com">
              <div class="mt-3">
                <font-awesome-icon
                  :icon="['fas', 'envelope']"
                  class="text-lg"
            ...
            <nuxt-link to="/resume">
              <div class="mt-3">
                <font-awesome-icon
                  ...
                  class="text-lg"
                />
                <span class="ml-4 capitalize">Currículo</span>
              </div>
            </nuxt-link>
          ...
          <div class="absolute bottom-0 mb-3">
            <a href="https://www.linkedin.com/in/pgabrielsw" target="_blank">
              <font-awesome-icon :icon="['fab', 'linkedin']" class="text-lg" />
            </a>
            <a href="https://github.com/pgabrielsw" target="_blank">
              <font-awesome-icon
                :icon="['fab', 'github']"
                class="text-lg ml-3"
              />
